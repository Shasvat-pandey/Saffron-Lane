  ...
  return (
    <nav className={sticky ? "dark-nav" : ""}>
      <div className="nav-left-wrapper">
        <div
          className={`hamburger-icon ${mobilemenu ? "active" : ""}`}
          onClick={togglemenu}
        >
          <span></span>
          <span></span>
      ...
      <ul className={mobilemenu ? "show-mobile-menu" : "hide-mobile-menu"}>
        ...
        {/* Dynamic Auth Button / Avatar with Dropdown */}
        <li>
          {user ? (
            <div
        ...
        {/* In Navbar.jsx - Update the Reserve Button block */}
        {location.pathname !== "/reservation" && (
          <li>
            <Link
              to={user ? "/reservation" : { pathname: '/auth', state: { from: location.pathname } }}
              onClick={() => setMobilemenu(false)}
